...
@Component({
  selector: 'app-psicologia-oncologica',
  standalone: false,
  templateUrl: './psicologia-oncologica.component.html',
  styleUrl: './psicologia-oncologica.component.scss'
})
export class PsicologiaOncologicaComponent {
  twallConfig = {
    eyebrow: 'TESTIMONIOS',
